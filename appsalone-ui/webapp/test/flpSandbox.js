		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SApp Title",
									"targetURL": "#comsappappsaloneui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsappappsaloneui-display": {
								"semanticObject": "comsappappsaloneui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sapp.appsaloneui",
									"url": sap.ui.require.toUrl("com/sapp/appsaloneui")
								}
							}
						}
					}
